...
#     print(number)
# except ValueError:
#     print(f"Error: '{invalid_string}' cannot be converted to an integer.")
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
# # Find index
# print(course_name.upper().find("P"))
# # Boolean
# print("pro" in course_name)
# print("Eevee" not in course_name)
...
# # For math modules google "python 3 math module"
# print(math.ceil(2.2))
...
#     print("Pack a coat")
# else:
#     print("Dawg it too cold")
# print("Done")

# age = 23
# # message = "Old enough" if age >= 21 else "Too young"
# # print(message)
...
# # print("Eligible") if (high_income or good_credit) and not is_student else print("Not eligible")
# if 18 <= age < 65:
#     print("Yuh")


# count = 0  # start, end, step
...
# for char in "Evelynn's Astral World!":
#     print(char)

# for list in [1, 2, 3, 4, 5]:
#     print(list)

# shopping_list = ["Apples", "Brownies", "Milk", "Eggs"]
...
#         print(x)
#         count += 1
# print(f"We got {count} even #'s")


# def babys_first_method():
#     print("Holy C.O.W.")
#     print("Norway")
...
#     print(f"Hi {last_name}, {first_name}! Welcome on in....")


# create_user("Eevee", "Atlas")
# create_user(3, 2)
